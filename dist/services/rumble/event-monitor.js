...
async function detectEvents(metrics) {
    ...
    for (const milestone of exports.TRIGGER_EVENTS.subscriber_milestone) {
    ...
    if (metrics.viewVelocity > exports.TRIGGER_EVENTS.viral_video.views_1h) {
